...
- (CAShapeLayer*) drawingPointsForChartData : (PNScatterChartData *) chartData AndWithX : (CGFloat) X AndWithY : (CGFloat) Y
{
    if (chartData.inflexionPointStyle == PNScatterChartPointStyleCircle) {
        ...
        circle.strokeColor = (__bridge CGColorRef)([UIColor blueColor]);
        circle.lineWidth =1;
        ...
        // Configure the apperence of the circle
        square.fillColor = (__bridge CGColorRef)([UIColor blueColor]);
        square.strokeColor = (__bridge CGColorRef)([UIColor blueColor]);
        square.lineWidth = 1;
