...
- (void)strokeChart
{
    ...
    for (NSUInteger lineIndex = 0; lineIndex < self.chartData.count; lineIndex++) {
        ...
        chartLine.fillColor=[UIColor colorWithRed:124/255.0 green:164/255.0 blue:174/255.0 alpha:1.0].CGColor;
        pointLayer.path = pointPath.CGPath;
        pointLayer.borderColor = [UIColor colorWithRed:55/255.0 green:177/255.0 blue:203/255.0 alpha:1.0].CGColor;
        pointLayer.fillColor= [UIColor colorWithRed:55/255.0 green:177/255.0 blue:203/255.0 alpha:1.0].CGColor;
    ...
    for (NSUInteger lineIndex = 0; lineIndex < self.chartData.count; lineIndex++) {
        ...
        for (NSUInteger i = 0; i < chartData.itemCount; i++) {
            ...
            if (chartData.inflexionPointStyle == PNLineChartPointStyleCircle) {
                chartData.inflexionPointWidth=innerGrade;
...
- (void)setChartData:(NSArray *)data
{
    if (data != _chartData) {
        ...
        for (PNLineChartData *chartData in data) {
            ...
            pointLayer.strokeColor   = [UIColor colorWithRed:55/255.0 green:177/255.0 blue:203/255.0 alpha:1.0].CGColor;
            pointLayer.lineCap       = kCALineCapRound;
            pointLayer.lineWidth     = .5;
