...
- (void)configureCell
{
    ...
    CGRect title=_backgroundLayer.frame;
    title.origin.x=1;
    title.origin.y=1;
    title.size.height=42;
    title.size.width=44;
    _backgroundLayer.frame=title;
    ...
    if (_subtitleLabel.text) {
        ...
        _titleLabel.frame = CGRectMake(0, 3, self.fs_width, floor(self.contentView.fs_height*5.0/6.0));
        _subtitleLabel.hidden = YES;
    }
    
    _backgroundLayer.hidden = !self.isToday; //!self.selected && !self.isToday;
